...
export const ORDER_SHIPPING_UPDATE_REQUEST = 'ORDER_SHIPPING_UPDATE_REQUEST';
export const ORDER_SHIPPING_UPDATE_SUCCESS = 'ORDER_SHIPPING_UPDATE_SUCCESS';
export const ORDER_SHIPPING_UPDATE_FAIL = 'ORDER_SHIPPING_UPDATE_FAIL';
export const ORDER_SHIPPING_UPDATE_RESET = 'ORDER_SHIPPING_UPDATE_RESET';
